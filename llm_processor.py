...
NARRATIVE_GROWTH_LIVE_PROMPT = (
    ...
    "請幫我揉合這兩者，提煉成 3 點極具洞察力的繁體中文大白話報告，嚴格遵守以下結構，絕對禁止任何客套廢話："
    "1. 【核心商業基因】：用一句話點穿這家公司底層靠什麼核心技術/業務賺錢（來自靜態摘要）。"
    "2. 【最新科技嘗試與技術動態】：結合【即時新聞】，指出他們最近這幾天/這幾週在投入什麼新研發、"
    "新產品、法說會透露了什麼新指引，或有什麼重大商業合作？"
    "3. 【右側動能催化劑 (Catalyst)】：結合技術面突破的事實與最新消息，"
    "分析為什麼市場資金最近會選擇拉抬這檔股票？（例如：板塊輪動、對手暴雷、新單大爆發）。"
    "注意：字數嚴格控制在 200 字內，要讓專業投資人能一目了然最新進展，"
    "讓 CS 大學生也能秒懂技術壁壘。"
...
def _format_trend_context(trend_signal: dict | None) -> str:
    ...
    if above_both:
        lines.append("- Note: Bullish right-side breakout / base formation in progress.")
    return "\n".join(lines)
